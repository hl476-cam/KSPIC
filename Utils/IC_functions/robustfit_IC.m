function varargout = robustfit_IC(X,y,wfun,alpha,tune,const,priorw,dowarn)

% Modified based on ROBUSTFIT.
...
if nargin<4, alpha = 1.5; end

if nargin<5, tune = []; end
[wfun,tune] = statrobustwfun_IC(wfun,tune,alpha);
...
[varargout{:}] = statrobustfit_IC(X,y,wfun,tune,wasnan,doconst,priorw,dowarn,alpha);
